...
CREATE TABLE "movie" (
    ...
    "vod_service" VARCHAR(255) NOT NULL,
...
-- AddForeignKey
ALTER TABLE "comment" ADD CONSTRAINT "comment_movie_id_fkey" FOREIGN KEY ("movie_id") REFERENCES "movie"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
