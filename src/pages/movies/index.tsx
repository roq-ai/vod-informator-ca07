...
export function MovieListPage(props: MovieListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getMovies({
        relations: [, 'comment.count', 'favorite.count'],
        limit: params.pageSize,
        offset: params.pageNumber * params.pageSize,
        searchTerm: params.searchTerm,
        order: params.order,
        searchTermKeys: ['name.contains', 'category.contains', 'vod_service.contains', 'interesting_facts.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'vod_service', header: 'Vod Service', accessorKey: 'vod_service' },
    { id: 'cost', header: 'cost', accessorKey: 'cost' },
    { id: 'interesting_facts', header: 'Interesting Facts', accessorKey: 'interesting_facts' },
